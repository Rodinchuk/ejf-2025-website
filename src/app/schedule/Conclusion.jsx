  ...
  return (
    <div className={styles.conclusion}>
      ...
      <div className={styles.conclusioncontent}>
        ...
        <h2 className={styles.title}>Додайте розклад у ваш календар!</h2>
        <p className={styles.description}></p>
        <a href="" className={styles.conclusionlink}>
        <button className={styles.conclusionbutton}>Додати в календар</button>
