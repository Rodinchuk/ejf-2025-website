...
<span style={{color: "#767676", fontSize: "14px",fontWeight: "400"}}>Останній капіталіст</span></li>
                    ...
                    <li><span style={{color: "#767676", fontWeight: "400"}}>13:30</span> <span style={{color: "#257BFC", fontSize: "21px", fontWeight: "700"}} className={styles.eventies}>Панельна дискусія</span><br /><span style={{color: "#767676", fontSize: "14px", fontWeight: "400"}}>Назар Тимошик, Володимир Назаркевич, Віталій Якушев</span></li>
