        ...
        <div className={styles.scheduleWrapper}>
            <div className={styles.day}>
                ...
                <ul>
                    ...
                    <li><span style={{color: "#767676", fontWeight: "400"}}>11:25</span> <span style={{color: "#257BFC", fontSize: "21px", fontWeight: "700"}} className={styles.eventies}>Інфозони + Співбесіди</span></li>
